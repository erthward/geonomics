...
def find_mates(pop, land=None, sex=False, repro_age=None,
    ...
    if sex:
        ...
        available_females = np.array(dists[:, 1] != np.inf) & np.array(sexes[pairs[:,0]] == 0)
...
def draw_n_births(num_pairs, n_births_distr_lambda, fecundity=1):
    ...
    #chosen to mate
    num_births = r.poisson((n_births_distr_lambda * fecundity) - 0.999999, num_pairs)
