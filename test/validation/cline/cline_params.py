...
#env_array = np.hstack((np.zeros((100,30)),
#                       np.ones((100,10))*0.1,
#                       np.ones((100,8))*0.2,
#                       np.ones((100,2))*0.4,
#                       np.ones((100,2))*0.6,
...
#                       np.ones((100,10))*0.9,
#                       np.ones((100,30))))
#env_array = np.zeros((99,99))
#env_array[49,49] = 1
#env_array = nlmpy.distanceGradient(env_array)
#env_array[env_array<0.45] = 0
#env_array[env_array>0.55] = 1
#source_array = np.hstack((np.ones((50,11)), np.zeros((50,29))))
#env_array = nlmpy.distanceGradient(source_array)
#env_array = np.hstack((env_array, np.ones((50,10))))
array_center_vals = np.linspace(0.25, 0.75, 20)
array_center_vals = 0.5+-0.5*np.sin(2*pi*array_center_vals)
array_vals = np.hstack(([0]*15, array_center_vals, [1]*15))
env_array = np.vstack([array_vals]*50)
#K_array = np.ones((100,100))
K_array = np.ones((99,99))
