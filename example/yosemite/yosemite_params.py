...
###################
    ...
    ##############
        'main': {
            ...
            'res':                      (0, 0),
            #'res':                      (0.013333333332754,
            #                             -0.008888888888503),
            #upper-left corner of the Landscape
            'ulc':                      (0, 0),
            #'ulc':                      (-120.304166666548184,
            #                             38.254166666118202),
            #projection of the Landscape
            'prj':                      None,
            #'prj':                      ('GEOGCS["NAD83",DATUM["North_American'
            #                             '_Datum_1983",SPHEROID["GRS 1980",'
            #                             '6378137,298.2572221010042,AUTHORITY'
            #                             '["EPSG","7019"]],TOWGS84'
            #                             '[0,0,0,0,0,0,0],AUTHORITY'
            #                             '["EPSG","6269"]],PRIMEM'
            #                             '["Greenwich",0],UNIT["degree",'
