...
def make_params_file(scapes=1, pops=1, model=None):
    '''
    Write a new template params file (to then be filled in by the user).

    Arguments:
        'scapes' can be of the following types:
            int:
                Will produce the stipulated number of Scapes, each with default
                settings:
                    - no ScapeChanger
            [dict, ..., dict]:
                Each dict should be of the form:
                    {'change': bool}.
                This will produce a number of scapes equal to the number of
                dicts in the list, each scape with or without scape change, as
                indicated.

        'pops' can be of the following types:
            int:
                Will produce the stipulated number of Populations, each with
                default settings:
            ...
            [dict, ..., dict]:
                Each dict should be of the form:
                    XXXXXXXXX.
                This will produce a number of Populations equal to the number
                of dicts in the list, with each Population parameterized as 
                indicated.


'''
    scapes_params_str = None

    pops_params_str = None

    seed_params_str = None

    its_params_str = None

    data_params_str = None

    stats_params_str = None
