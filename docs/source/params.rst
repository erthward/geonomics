...
will still undergo natal dispersal, but after dispersing
...
set to reflect a distribution of natal dispersal distances that is appropriate
for your scenario.
The distribution to which this parameter applies depends on the value
...
This determines whether natal dispersal is modeled using a lognormal distribution
('lognormal'; default), a Lévy distribution ('levy'),
or a Wald distribution ('wald').
...
Movement and Natal Dispersal _ConductanceSurfaces
"""""""""""""""""""""""""""""""""""""""""""
...
If :py:`tskit` is used then the full ancestral recombination graph (ARG)
and full spatial pedigree will be available at any time,
and each Individual will carry a numpy.ndarray
...
and not needing access to the ARG or spatial pedigree
